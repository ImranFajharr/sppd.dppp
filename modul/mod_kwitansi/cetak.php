...
<?php
$t=mysql_fetch_array(mysql_query("SELECT * FROM kwitansi,pegawai,golongan WHERE id_kwitansi='$_GET[id]' AND kwitansi.id_pegawai=pegawai.id_pegawai AND golongan.id_golongan=pegawai.id_golongan"));
$lama = $t['lama'];
