...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="h3 mb-0 text-gray-800"><i class="fas fa-fw fa-cogs"></i> Data Instansi</h1>
	
	<a href="?module=instansi&act=editinstansi&id=<?php echo $r['id'] ?>" class="btn btn-warning"> <i class="fa fa-edit"></i> Edit Data </a>
</div>

<div class="card shadow mb-4">
    <!-- /.card-header -->
    <div class="card-header py-3">
        <h6 class="m-0 font-weight-bold text-warning"><i class="fa fa-table"></i> Daftar Data Instansi</h6>
    </div>
...
break;
case "editinstansi":
$edit=mysql_query("SELECT * FROM instansi WHERE id='$_GET[id]'");
...
<div class="card shadow mb-4">
    <div class="card-header py-3">
        <h6 class="m-0 font-weight-bold text-warning"><i class="fas fa-fw fa-edit"></i> Edit Data</h6>
    </div>
